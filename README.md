# 🎓 Formation Azure - 7 Labs Pratiques
...
- **Données**: AdventureWorksLT (exemple)
...
✅ **Objectifs Pédagogiques SMART** - Chaque lab avec objectifs clairs et mesurables  
✅ **Schémas d'Architecture** - Diagrammes ASCII pour visualiser l'infrastructure  
✅ **Étapes Détaillées** - Tâches numérotées avec tous les paramètres requis  
✅ **Questions de Révision** - Évaluation des connaissances acquises  
✅ **Dépannage Intégré** - Solutions aux problèmes courants  
✅ **Format Markdown** - Compatible GitHub, GitLab, Obsidian, etc.  
✅ **Liens Officiels** - Documentation Microsoft officielle  
✅ **Optimisation Coûts** - Estimation des dépenses Azure  
...
| Métrique | Valeur |
|----------|--------|
| **Nombre de Labs** | 7 labs complets |
| **Nombre de Tâches** | 70+ tâches détaillées |
| **Durée totale** | 4h 30m - 6h 00m |
| **VMs à créer** | 10 machines virtuelles |
| **Services Azure** | 7 services couverts |
| **Coût estimé** | ~$1.00 (si nettoyage après chaque lab) |
| **Niveau d'étude** | Débutant à Intermédiaire |
...
```bash
git clone https://github.com/votre-username/azure-labs.git
cd azure-labs
```
...
```bash
# Ouvrir le Lab 01 avec votre éditeur préféré
cat 01-Machine-Virtuelle-Linux.md

# Ou utiliser GitHub pour lire directement
# https://github.com/votre-username/azure-labs/blob/main/01-Machine-Virtuelle-Linux.md
```

### 3. Suivre les Étapes

- Lisez l'ensemble du lab
- Vérifiez les prérequis
- Suivez les tâches dans l'ordre
- Répondez aux questions de révision
- **Important**: Supprimez les ressources après le lab!
